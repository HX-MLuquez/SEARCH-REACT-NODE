...
## Crear una Aplicación de Búsqueda y Visualización de Productos

- Objetivo: Crear una aplicación web que permita a los usuarios buscar y ver detalles de productos utilizando HTML, JavaScript, React, Node.js y Express.

### Requisitos:

1. Crear un archivo data.json con una lista de productos en formato JSON (proporcionado en la pregunta).

2. Crear una aplicación cliente utilizando React con los siguientes componentes:

    - a) SearchBar: Un campo de búsqueda que permita a los usuarios filtrar los productos por título.

    - b) ProductList: Muestra una lista de productos que coinciden con la búsqueda. Cada producto debe mostrar su título y precio. Al hacer clic en un producto, se debe mostrar su detalle.

    - c) ProductDetail: Muestra los detalles completos de un producto cuando se hace clic en él, incluyendo título, precio, descripción, condición y stock.

3. Crear un servidor utilizando Node.js y Express:

    - a) El servidor debe proporcionar una ruta /api/products que devuelva la lista de productos desde data.json.

    - b) La aplicación cliente debe comunicarse con el servidor para obtener la lista de productos y mostrar los detalles del producto seleccionado.

Los componentes deben estar organizados en archivos separados y utilizar props para la comunicación entre componentes.

### Puntos extra (opcional):

- Estilizar la aplicación utilizando CSS puro o algún framework para mejorar la apariencia visual.
- Agregar funcionalidad para mostrar un mensaje cuando no se encuentren productos con la búsqueda.
- Implementar un enrutamiento utilizando React Router para mostrar los detalles del producto en una página separada.

¡Diviértete creando la aplicación de búsqueda y visualización de productos! No dudes en agregar características adicionales y mejorar la aplicación según tus habilidades y creatividad. ¡Buena suerte!

Adjunto json a utilizar:
